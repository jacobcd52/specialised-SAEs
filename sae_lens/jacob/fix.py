...
for l1_coefficient in [30, 20]:
    cfg = LanguageModelSAERunnerConfig(
        ...
        dataset_path="NeelNanda/openwebtext-tokenized-9b",  # this is a tokenized language dataset on Huggingface for the Tiny Stories corpus.
